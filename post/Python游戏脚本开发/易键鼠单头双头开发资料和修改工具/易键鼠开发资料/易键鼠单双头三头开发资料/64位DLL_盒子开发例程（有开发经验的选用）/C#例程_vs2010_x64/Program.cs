...
namespace M_dll_demo
{
    public class M_dll_demo
    {
        ...
        public class msdk_DLL_Ifx
        {
            ...
            [DllImport("msdk.dll", EntryPoint = "M_ScanAndOpen", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
            public static extern IntPtr M_ScanAndOpen();
            ...
            [DllImport("msdk.dll", EntryPoint = "M_ChkSupportMdy", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
			public static extern int M_ChkSupportMdy(IntPtr m_hdl);
			//读取当前绝对移动功能的状态 返回: 1:打开; 0:关闭; 其他: 错误
            [DllImport("msdk.dll", EntryPoint = "M_GetAbsCfg", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
			public static extern int M_GetAbsCfg(IntPtr m_hdl);
			//设置绝对移动功能: e1d0=1 打开; =0;关闭
            [DllImport("msdk.dll", EntryPoint = "M_SetAbsCfg", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
			public static extern int M_SetAbsCfg(IntPtr m_hdl, int e1d0);
			//设置新VID/PID
            [DllImport("msdk.dll", EntryPoint = "M_SetNewVidPid", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
			public static extern int M_SetNewVidPid(IntPtr m_hdl, int mVid, int mPid, int sVid, int sPid);
            [DllImport("msdk.dll", EntryPoint = "M_ResetVidPid", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
			public static extern int M_ResetVidPid(IntPtr m_hdl);
			//读取VID/PID; IdIndex=1/2/3/4 分别对应 主控端Vid, 主控端Pid, 被控端Vid, 被控端Pid
            [DllImport("msdk.dll", EntryPoint = "M_GetVidPid", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
			public static extern int M_GetVidPid(IntPtr m_hdl, int IdIndex);
			
			//是否支持修改产品名称, 返回值1=支持，0=不支持；-1，失败
            [DllImport("msdk.dll", EntryPoint = "M_ChkSupportProdStrMdy", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
			public static extern int M_ChkSupportProdStrMdy(IntPtr m_hdl);
			//读取产品名称
            [DllImport("msdk.dll", EntryPoint = "M_GetProdStr", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
			public static extern int M_GetProdStr(IntPtr m_hdl, int m0s1, ref int LenOfStr, ref byte ucp_Str);
			//设置产品名称
            [DllImport("msdk.dll", EntryPoint = "M_SetProdStr", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
			public static extern int M_SetProdStr(IntPtr m_hdl, int m0s1, int LenOfStr, ref byte ucp_Str);
			
			//是否支持加密功能, 返回值1=支持，0=不支持；-1，失败
            [DllImport("msdk.dll", EntryPoint = "M_ChkSupportEnc", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
			public static extern int M_ChkSupportEnc(IntPtr m_hdl);
			//检测密码状态; 返回值: <0 错误；255=无密码; 0~16:密码剩余有效次数
            [DllImport("msdk.dll", EntryPoint = "M_ChkPwStat", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
			public static extern int M_ChkPwStat(IntPtr m_hdl);
			//设置新密码
            [DllImport("msdk.dll", EntryPoint = "M_SetPw", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
			public static extern int M_SetPw(IntPtr m_hdl, int PwLen, int PwMaxCnt, ref byte ucp_pw);
			//验证密码
            [DllImport("msdk.dll", EntryPoint = "M_VerifyPw", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
			public static extern int M_VerifyPw(IntPtr m_hdl, int PwLen, ref byte ucp_pw);
			//写入数据
            [DllImport("msdk.dll", EntryPoint = "M_WrEncData", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
			public static extern int M_WrEncData(IntPtr m_hdl, int DataLen, ref byte ucp_data);
			//读取数据
            [DllImport("msdk.dll", EntryPoint = "M_RdEncData", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
			public static extern int M_RdEncData(IntPtr m_hdl, int DataLen, ref byte ucp_data);
