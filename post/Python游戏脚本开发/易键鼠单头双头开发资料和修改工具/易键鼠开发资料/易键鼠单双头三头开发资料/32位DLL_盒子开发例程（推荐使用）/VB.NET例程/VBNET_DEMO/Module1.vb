Module Module1
    ...
    Declare Function M_ScanAndOpen Lib "msdk.dll" () As Integer
    '关闭端口；在程序退出前再关闭端口
	...
	'DLL内部参数恢复默认值
	Declare Function M_InitParam Lib "msdk.dll" (ByVal m_hdl As Integer) As Integer
	'设置DLL内部参数
	...
	Declare Function M_ChkSupportMdy Lib "msdk.dll" (ByVal m_hdl As Integer) As Integer
	'读取当前绝对移动功能的状态 返回: 1:打开; 0:关闭; 其他: 错误
	Declare Function M_GetAbsCfg Lib "msdk.dll" (ByVal m_hdl As Integer) As Integer
	'设置绝对移动功能: e1d0=1 打开; =0;关闭
	Declare Function M_SetAbsCfg Lib "msdk.dll" (ByVal m_hdl As Integer, ByVal e1d0 As Integer) As Integer
	'设置新VID/PID
	Declare Function M_SetNewVidPid Lib "msdk.dll" (ByVal m_hdl As Integer, ByVal mVid As Integer, ByVal mPid As Integer, ByVal sVid As Integer, ByVal sPid As Integer) As Integer
	Declare Function M_ResetVidPid Lib "msdk.dll" (ByVal m_hdl As Integer) As Integer
	'读取VID/PID; IdIndex=1/2/3/4 分别对应 主控端Vid, 主控端Pid, 被控端Vid, 被控端Pid
	Declare Function M_GetVidPid Lib "msdk.dll" (ByVal m_hdl As Integer, ByVal IdIndex As Integer) As Integer
	'是否支持修改产品名称, 返回值1=支持，0=不支持；-1，失败
	Declare Function M_ChkSupportProdStrMdy Lib "msdk.dll" (ByVal m_hdl As Integer) As Integer
	'读取产品名称
	Declare Function M_GetProdStr Lib "msdk.dll" (ByVal m_hdl As Integer, ByVal m0s1 As Integer, ByRef LenOfStr As Integer, ByRef ucp_Str As Byte) As Integer
	'设置产品名称
	Declare Function M_SetProdStr Lib "msdk.dll" (ByVal m_hdl As Integer, ByVal m0s1 As Integer, ByVal LenOfStr As Integer, ByRef ucp_Str As Byte) As Integer
	'是否支持加密功能, 返回值1=支持，0=不支持；-1，失败
	Declare Function M_ChkSupportEnc Lib "msdk.dll" (ByVal m_hdl As Integer) As Integer
	'检测密码状态; 返回值: <0 错误；255=无密码; 0~16:密码剩余有效次数
	Declare Function M_ChkPwStat Lib "msdk.dll" (ByVal m_hdl As Integer) As Integer
	'设置新密码
	Declare Function M_SetPw Lib "msdk.dll" (ByVal m_hdl As Integer, ByVal PwLen As Integer, ByVal PwMaxCnt As Integer, ByRef ucp_pw As Byte) As Integer
	'验证密码
	Declare Function M_VerifyPw Lib "msdk.dll" (ByVal m_hdl As Integer, ByVal PwLen As Integer, ByRef ucp_pw As Byte) As Integer
	'写入数据
	Declare Function M_WrEncData Lib "msdk.dll" (ByVal m_hdl As Integer, ByVal DataLen As Integer, ByRef ucp_data As Byte) As Integer
	'读取数据
    Declare Function M_RdEncData Lib "msdk.dll" (ByVal m_hdl As Integer, ByVal DataLen As Integer, ByRef ucp_data As Byte) As Integer
